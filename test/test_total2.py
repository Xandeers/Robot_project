                ...
                if frame is not None:
                    ...
                    if robot_info and is_calibrated:
                        ...
                        if terrain_manager.is_in_zone(pos_robot, 0):
                            ...
                            coord_robot_cm = mon_graph.convertir_pixel_to_graph(pos_robot[0], pos_robot[1], cam_id=1, angle_cam=angle_camera)
                        elif terrain_manager.is_in_zone(pos_robot, 1):
                          
                            coord_robot_cm = mon_graph.convertir_pixel_to_graph(pos_robot[0], pos_robot[1], cam_id=2, angle_cam=angle_camera)
